...
def run_experiment(alg_name, alg_func, sizes):
    ...
    results_file_csv = os.path.join(results_dir, f"{alg_name}_results.csv")
    ...
    with open(results_file_csv, "w", newline='') as csvfile:
        fieldnames = ["size", "best_case_time", "best_case_memory", "worst_case_time", "worst_case_memory", "avg_case_time", "avg_case_memory"]
    ...
    logging.info(f"Resultados salvos em {results_file_csv}")
