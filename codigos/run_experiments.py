...
def run_experiment(alg_name, alg_func, sizes):
    ...
    # Carregar resultados existentes se o arquivo JSON já existir
    ...
    for size in sizes:
        ...
        log_experiment_result(timestamp, alg_name, size, "médio", avg_time, avg_memory)
        result_avg = {
            "timestamp": timestamp,
            "algorithm": alg_name,
            "size": size,
        ...
        # Salvar resultados em JSON após cada rodada
